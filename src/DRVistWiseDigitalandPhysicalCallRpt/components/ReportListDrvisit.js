...
import ReportTableDrvisit from './ReportTableDrvisit'
import "../../../public/assets/css/campaignRequest.css";
import {postToServer} from '../../lib/comm-utils'
import Loder from  '../../lib/Loader'


class ReportListDrvisit extends Component{
    constructor(props){
        super(props)
        this.state={
            selecteddiv:'',
    ...
    applyFilterAll(){
        ...
        if(this.state.selarea=="")
         {
            alert("FS Area not Selected ............")
                    return;
        }
        if(this.state.selfs=="")
         {
            alert("FS Name not Selected ............")
                    return;
        }
        ...
        this.setState({ loader:true })
    //     var travelModes={ "Report":"DrVisitWiseDigitalPhyCall","index": "GetReportData",  data:{"DivCode":"-999","RegCode":"-999","DistCallType":"-999"}  }
...
export default ReportListDrvisit