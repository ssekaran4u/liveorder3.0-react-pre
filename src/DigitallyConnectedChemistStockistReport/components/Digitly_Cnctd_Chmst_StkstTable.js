...
import Digitly_Cnctd_Chmst_StkstOptions from './Digitly_Cnctd_Chmst_StkstOptions'



class Digitly_Cnctd_Chmst_StkstTable extends Datatable {
   constructor(props){
    super(props)
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                        ...
                        <Digitly_Cnctd_Chmst_StkstOptions filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
                    ...
                    <Col xs={12} className="datatable">
                        <div className="table-responsive analysistableheight">
                            ...
                            <thead style={{textAlign:"center"}}>
                                <tr>
                                    <th  colSpan="8" style={{fontWeight: 'bold'},{fontSize:'20px'}}>Digitally Connected Chemist and Stockits Report</th>
                                </tr>
                                </thead>
                                <TableHeader
                                    tableHeader={tableHeader}
