...
class Newdoctortable extends Component {
    constructor(props) {
        super(props);
        this.state={
    ...
    render() { 
       const header = [
            ...
            { prop: 'Opening Date', title: 'Opening Date', filterable: true, "sortable": true },
            { prop: 'Grade', title: 'Garde', filterable: true, "sortable": true },
...
export default  withRouter(Newdoctortable);