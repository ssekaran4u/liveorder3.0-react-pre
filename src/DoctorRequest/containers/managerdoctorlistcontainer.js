...
import Downlineapprovalcomponent from '../components/managercomponents/downlineapprovalcomponent'
                  ...
                  <div className="dashboard-sec ">
                      <div className="admindashboard-sfc">
                          ...
                          <Tabs  id="controlled-tab-example"
                            ...
                            <Tab eventKey="newdoctortab" title="New Doctor Request List">
                              <Newdocreqlist/>
                              <Link to = {{
