...
class ClaimTable extends Datatable{
        ...
        return (
            <div >
                 ...
                 <div className="flex-row">
                        <div className="dwrSubHeading mainhead_content_one bartitle">Distributor Claim List</div>
                            <div className="flexDisplay claimresponsive">
                            <div>
                        ...
                        <div className="admin_component_head_icon">
                            <div className="headicon_position">
                                {this.state.isFull ? (
                                    ...
                                    <img className="dashfullscreen" src="../public/assets/images/overflow.svg" />
                            </div>
                        </div>
                        </div>
