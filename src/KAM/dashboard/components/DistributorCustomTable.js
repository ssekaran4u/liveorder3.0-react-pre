...
class DistributorCustomTable extends Datatable {
    render() {
            ...
            <div>
                 <div className="flex-row">
                    ...
                    <div className="flexDisplay requestDropList">
                        ...
                        <div>
                            <div className="other-ops kdashboradpad ksearch">
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item href="#/action-1" >
                                        <div className="statusdropmenu" >
                                            ...
                                            <div className="pipelinePad">Region</div>
...
export default DistributorCustomTable;
