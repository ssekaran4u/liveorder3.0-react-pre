...
class OrderListCustomTable extends Datatable {
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item href="#/action-1" >
                                        <div className="statusdropmenu" >
                                            <div className="pipelinePad">01 - 02 L</div>
                                            <div className="pipelinePad">03 - 05 L</div>
                                            <div className="pipelinePad">05 - 10 l</div>
                            ...
                            <div className="other-ops admindas ksearch">
                                <div class="form-group">
                                    <span className="input-group">
                                        <input placeholder="Search by product" type="text"  className="searchBox" value="" />
...
export default OrderListCustomTable;
