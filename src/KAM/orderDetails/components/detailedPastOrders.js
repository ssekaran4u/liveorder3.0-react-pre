...
import DetailedPastOrdersCustomTable from './detailedPastOrdersCustomtable';
import { Link } from "react-router-dom";

class DetailedPastOrders extends Component {
    render() {
        const header = [
...
export default DetailedPastOrders;
