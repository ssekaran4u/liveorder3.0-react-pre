...
import FilterOptionDropMEDistDetailsummary from './FilterOptionDropMEDistDetailsummary'
import {postToServer} from '../../lib/comm-utils'
import StatusPopup from '../../lib/StatusPopup'

class FilterOptionsMEDistDetailsummary extends Component {
    constructor(props){
        super(props)
        this.state={
            year:'',
...
//filter of division
    ...
    getDistanceCall(dis){
      let returArray={"name":"Division","rvalue":dis};
      this.setState({DistanceCall2:dis});
      this.props.funcprops(returArray)  
    }
    getCategory(categ){
      let returArray={"name":"Division","rvalue":categ};
    ...
    componentDidMount(){
      this.setState({Division2:"-999"});
        ...
        var travelModes = {"Report":"MeDistDetailsSummary","index": "Divisions",  data:{}  }
      ...
      postToServer("Reportsapi", travelModes).then((Result) => {
        ...
        var regdet = {"Report":"MeDistDetailsSummary","index": "Regions",  data:{}  }
    ...
    var brnd = {"Report":"MeDistDetailsSummary","index": "DistanceCall",  data:{}  }
...
var ca = { "Report":"MeDistDetailsSummary","index": "Category",  data:{}  }
                                        ...
                                        <div className='retrival-right '>
                                            <Tab.Content>
                                                <Tab.Pane eventKey="Division">
                                                    <FilterOptionDropMEDistDetailsummary 
                                                        name="Division" 
                                                        options={Division} 
...
export default FilterOptionsMEDistDetailsummary