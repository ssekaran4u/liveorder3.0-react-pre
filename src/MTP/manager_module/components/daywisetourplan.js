...
import DaywiseTourPlanBody from "./daywisetourplanBody";
...
class DaywiseTourplan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isFull: false,
...
console.log(this.state.showcal,"showcal")
        ...
        const header = [
            ...
            { prop: 'Date', title: 'Date', sortable: true, filterable: true },
            ...
            { prop: 'workwith', title: 'Working With', filterable: true },
            { prop: 'typeofwork', title: 'Type of Work', filterable: true },
        ...
        // var Action =<div className="exp-view"><img src = {Group1727}/> &nbsp; <img src = {Group1729}/></div>
        ...
        return (
            <div className="dcr-list-sec">
                ...
                <div className="fullimgmrtp">
                    <div className="mrtplistheader">Tour Plan for March, 2020</div>
                   
                    <div className="tpheader-fullscreen">
                        <div className="tpheader" >Approved By : <span className="tpmngrapprovedate">Manager 23,</span> Date : <span className="tpmngrapprovedate">20-Nov-19.</span></div>
                        {this.state.isFull ?
...
export default DaywiseTourplan;