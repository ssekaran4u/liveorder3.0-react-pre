...
class MrTPLISTBody extends Datatable {
                 ...
                 {/* <div>
                    ...
                    <div className="flex-row">
                        ...
                        <div className="other-ops">
                            <div className="">
                            <div>
                            <Button className="sfcAddBtn-loaditem onapprmrtp" >Approve</Button>
                            <Button className="sfcAddBtn-loaditem onrejectmrtp" >Reject</Button>
                            </div>
                                <Filter
