            ...
            <div className="uncheck-alert">
                <Modal centered className="mr-module-delete-popup" show={this.state.show} onHide={this.closeModal}>
                    <Modal.Body className="text-center">
                        <div className="successImgPad" ><img src="../public/assets/images/submitplan.svg" /></div>
        <div className="successText">{this.props.tital}</div>
                        <div className="successSubText">
                        <div className="success-text">{this.props.msg}</div>
                            <div className="successTxt">For  {this.state.month[this.props.Month]} {this.props.Year} </div>
