...
import AddCalloption from "./AddCalloption";
...
class DCRoptionTable  extends Datatable {
    ...
    render() {
        ...
        return (
            ...
            <div className="dcr-table">
              ...
              {/* <AddCalltype  loadfun={this.props.loadfun}  maxcode={this.props.maxcode}  /> */}
                {/* <div>
                            <h4 className="daily-call-report">
                                Distance Call option
                            </h4>
                        </div>*/}
                <AddCalloption   editdata={this.props.editdata} loadfun={this.props.loadfun}  maxcode={this.props.maxcode} showLoad = {this.props.showLoad} /> 
