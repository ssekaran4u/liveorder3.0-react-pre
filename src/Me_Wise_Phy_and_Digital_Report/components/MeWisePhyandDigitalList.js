...
import MeWisePhyandDigitalTable from './MeWisePhyandDigitalTable'
import {postToServer} from '../../lib/comm-utils'
import Loder from  '../../lib/Loader'
import { parse } from 'date-fns'

class MeWisePhyandDigitalList extends Component{
    constructor(props){
        super(props)
        this.state={
            selecteddiv:'',
    ...
    componentDidMount(){
        this.setState({header:
            // [
            //     { prop: 'Division', title: 'DIVISION', filterable: true,sortable:false, },
            //     { prop: 'Region', title: 'REGION', filterable: true,sortable:true },
            //     { prop: 'mename', title: 'ME NAME', filterable: true },
            //     { prop: 'mehq', title: 'ME HQ', filterable: true },
            //     { prop: 'month', title: 'MONTH', filterable: true },
            //     { prop: 'category', title: 'CATEGORY', filterable: true,sortable:true },
            //     { prop: 'a+1', title: 'A+', filterable: true },
            //     { prop: 'a1', title: 'A', filterable: true },
            //     { prop: 'total1', title: 'TOTAL', filterable: true,sortable:false, },
            //     { prop: 'a+2', title: 'A+', filterable: true },
            //     { prop: 'a2', title: 'A', filterable: true },
            //     { prop: 'total2', title: 'TOTAL', filterable: true,sortable:false, },
            //     { prop: 'a+3', title: 'A+', filterable: true },
            //     { prop: 'a3', title: 'A', filterable: true },
            //     { prop: 'total3', title: 'TOTAL', filterable: true,sortable:false, },
            //     { prop: 'dig1', title: 'DIGITALLY', filterable: true },
            //     { prop: 'phy1', title: 'PHYCALLY', filterable: true,sortable:false, },
            //     { prop: 'dpt1', title: 'TOTAL', filterable: true,sortable:true },
            //     { prop: 'gig2', title: 'DIGITALLY', filterable: true },
            //     { prop: 'phy2', title: 'PHYCALLY', filterable: true,sortable:false, },
            //     { prop: 'dpt2', title: 'TOTAL', filterable: true,sortable:true },
            //     { prop: 'dig3', title: 'DIGITALLY', filterable: true },
            //     { prop: 'phy3', title: 'PHYCALLY', filterable: true,sortable:false, },
            //     { prop: 'dpt3', title: 'TOTAL', filterable: true,sortable:true },
            //     { prop: 'dig4', title: 'DIGITALLY', filterable: true },
            //     { prop: 'phy4', title: 'PHYCALLY', filterable: true,sortable:false, },
            //     { prop: 'dpt4', title: 'TOTAL', filterable: true,sortable:true },
            //     { prop: 'FSCode', title: 'FS CODE', filterable: true },
            //     { prop: 'EMPCODE', title: 'EMPLOYEE CODE', filterable: true },
            ...
            { prop: 'dig3', title: 'DIGITALLY', filterable: true },
            { prop: 'phy3', title: 'PHYCALLY', filterable: true,sortable:false, },
            { prop: 'dpt3', title: 'TOTAL(NOT CONNECTED AT ALL)', filterable: true,sortable:true },
            { prop: 'dig4', title: 'DIGITALLY', filterable: true },
            { prop: 'phy4', title: 'PHYCALLY', filterable: true,sortable:false, },
            { prop: 'dpt4', title: 'TOTAL', filterable: true,sortable:true },
            { prop: 'FSCode', title: 'FS CODE', filterable: true },
...
export default MeWisePhyandDigitalList