...
import MeWisePhyandDigitalOptions from './MeWisePhyandDigitalOptions'



class MeWisePhyandDigitalTable extends Datatable {
   constructor(props){
    super(props)
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                        ...
                        <MeWisePhyandDigitalOptions filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
                    ...
                    <Col xs={12} className="datatable">
                        <div className="table-responsive analysistableheight">
                            ...
                            <thead style={{textAlign:"center"}}>
                                <tr>
                                    <th  colSpan="29" style={{fontWeight: 'bold'},{fontSize:'20px'}}>Me Wise Phy and Digital Report</th>
                                </tr>
                                </thead>
                                <TableHeader
                                    tableHeader={tableHeader}
