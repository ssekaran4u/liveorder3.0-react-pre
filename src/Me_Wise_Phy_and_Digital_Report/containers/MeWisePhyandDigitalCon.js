...
import MeWisePhyandDigitalHeader from "../components/MeWisePhyandDigitalHeader";
//import DCRListTable from "../components/DCRListTable";

import { connect } from "react-redux";
import MeWisePhyandDigitalList from "../components/MeWisePhyandDigitalList";

class MeWisePhyandDigitalCon extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <div className="min-height-100">
                    <div className="dcr-head">
                        <div>
                            <h4 className="daily-call-report">
                                {this.props.token}Me Wise Phy and Digital Report		
                            </h4>
                        </div>
                        <div>
                            <Breadcrumb className="dcr-breadcrumb">
                                ...
                                Me Wise Phy and Digital Report		
                                </Breadcrumb.Item>
                            </Breadcrumb>
                        </div>
                    </div>
                    ...
                    <div className="dcr-list-sec">
                        <div
                         ...
                         >
                             <MeWisePhyandDigitalHeader open={this.state.open} onHeaderHide={this.onHeaderHide}   />
                            <MeWisePhyandDigitalList  Devision={this.state.Devision} open={this.state.open} />
                        </div>
                    </div>
