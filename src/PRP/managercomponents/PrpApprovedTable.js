...
class PrpApprovedTable extends Datatable {
constructor(props){
super(props);			
}
selectMonth(month){
...
let c_status = this.props.statusfilter
return (
<div className=" ">
            ...
            <div className=" materialFilter" >
              ...
              <Dropdown.Menu className="manager_sales_filter_column-dropdown">
                <div className="month-padding columns-height cal-scrollbar">
                 {this.props.statusdropdown && this.props.statusdropdown != undefined ?
                  this.props.statusdropdown.map((item,index) => (
                  <DropdownItem 
                    key={index}
                    onClick={()=>this.filterStatusText(item.statuscode)} 
                    className="dropupItem" >{item.statustext}
                  </DropdownItem>
                  )):null}
                  </div>
              </Dropdown.Menu>
        ...
        <Dropdown.Menu className="manager_sales_filter_column-dropdown">
          <div className="month-padding columns-height cal-scrollbar">
            ...
            <DropdownItem 
              ...
              className="dropupItem" >{item.Name}
            </DropdownItem>
            )):null}
            </div>
          </Dropdown.Menu>
