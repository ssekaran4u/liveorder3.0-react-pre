...
import PrpReqTable from './PrpReqTable';
import {postToServer} from '../../lib/comm-utils';
import {withRouter} from 'react-router-dom'
import Loader from '../../lib/Loader'
class prpReqListTable extends Component {
    constructor(props) {
        super(props);
        this.state={
            monthList:[],
     ...
     componentDidMount(){
		 ...
		 getrequestList(month,year){
			...
			var data = {"Index":"MgrRequestsToApprove",
			"Data":{
    ...
    this.props.history.push('/PrpReqDetails/'+id)
	}
    render() { 
			const monthFilter = []
...
export default  withRouter(prpReqListTable);