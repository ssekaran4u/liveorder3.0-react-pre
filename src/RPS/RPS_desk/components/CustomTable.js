...
class CustomTable extends Datatable {
   constructor(props){
    ...
    getValue(code,name){
        this.props.getStatus(code,name)
    }
    render() {
                ...
                <Collapse in={this.props.toggleHeader}>
                    ...
                    <div className="dcr-table-options">
                        <div className="pagination-opts">
                            ...
                            {this.props.sendReq == "Frw" ?
                            <Dropdown>
                                <Dropdown.Toggle
                                    className="dcr-options"
                                    id="dropdown-basic"
                                >
                                    <div className="statusDrop flexDisplay">
                                        <div>
                                            <img
                                        ...
                                        <div>
                                            <div className="statusShow">{this.props.status}</div>
                                        </div>
                                    </div>
                            ...
                            // <SortStatusFilter option={statusFilter} defaultValue={month} getVal={getStatus} />
                            :''}
                            <Dropdown>
