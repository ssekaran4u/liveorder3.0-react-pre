...
import FilterOptionsDistDetailsummary from './FilterOptionsDistDetailsummary'



class ReportTableDistDetailsummary extends Datatable {
   constructor(props){
    super(props)
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                        ...
                        <FilterOptionsDistDetailsummary filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
                    ...
                    <Col xs={12} className="datatable">
                        <div className="table-responsive analysistableheight">
                            ...
                            <thead style={{textAlign:"center"}}>
                                <tr>
                                    <th  colSpan="8" style={{fontWeight: 'bold'},{fontSize:'20px'}}>Region Wise Distance Detail Summary Report</th>
                                </tr>
                                </thead>
                                {/* <tbody>
                                    <tr>
                                        ...
                                        <td>Month</td>
                                        <td>Category</td>
                                        <td>No of DRS in List</td>
                                        <td colSpan='2' align='center'>CLINIC SENTITIZATION
                                            <td>No of DRS engaged</td>
                                            <td>no of calls</td>
                                        </td>
                                    </tr>
                                </tbody> */}
