...
import RegWiseSmaryphyDigiTable from './RegWiseSmaryphyDigiTable'
import {postToServer} from '../../lib/comm-utils'
import Loder from  '../../lib/Loader'
import { parse } from 'date-fns'

class RegWiseSmaryphyDigiList extends Component{
    constructor(props){
        super(props)
        this.state={
            selecteddiv:'',
...
export default RegWiseSmaryphyDigiList