...
import RegWiseSmaryphyDigiOptions from './RegWiseSmaryphyDigiOptions'



class RegWiseSmaryphyDigiTable extends Datatable {
   constructor(props){
    super(props)
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        <ReactHTMLTableToExcel
                                            ...
                                            filename="Me Wise Phy and Digital Report"
                                            sheet="tablexls"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <RegWiseSmaryphyDigiOptions filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
                    ...
                    <Col xs={12} className="datatable">
                        <div className="table-responsive analysistableheight">
                            ...
                            <thead style={{textAlign:"center"}}>
                                <tr>
                                    <th  colSpan="29" style={{fontWeight: 'bold'},{fontSize:'20px'}}>Region Wise Summary Physical and Digital Report</th>
                                </tr>
                                {/* <tr>
                                    <td>Division</td>
                                    <td>REgion</td>
                                    <td>Month</td>
                                    <td>Category</td>
                                    <td colSpan="3">No of DRS in List</td>
                                    <td colSpan="3">TOTAL DR CONNECTED DIGITALLY</td>
                                    <td>TOTAL DR CONNECTED PHYCALLY</td>
                                    <td>TOTAL NO OF DOCTORS CONNECTED PHYCALLY AND DIGITALLY</td>
                                    <td>% COVERAGE</td>
                                    <td>NISSED DOCTORS</td>
                                    <td>CALL AVERAGE</td>
                                    <td>FS CODE</td>
                                    <td>EMPLOYEE CODE</td>
