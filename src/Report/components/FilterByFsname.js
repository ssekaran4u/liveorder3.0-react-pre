/*
* This code displays Fsname inside retrieval option of report
* Request URL=url/ReportDynamicDropdownQuery
* Index=2
* Request string={"id":"4","priority":"3","parameter":"16,TNH0012,.Fscode,.Ntpe","index":"2","Token":""}
* Response={
    fscode:MR1
    fsname:MR1(DIV 1)
}
...
class FilterByFsname extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            datafull: [],
    ...
    render() {
        return (
            <div className="repoDrop singledropdown mt-14 reportdiv">
