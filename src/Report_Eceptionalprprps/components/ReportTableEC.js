...
import FilterOptionsEC from './FilterOptionsEC'
import ColumnOption from '../../Report_RPSINVEST/components/ColumnOption'



class ReportTableEC extends Datatable {
   constructor(props){
    super(props)
    this.state = {
        ...this.state,
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        <ReactHTMLTableToExcel
                                            ...
                                            filename="Exceptional RPS/PRP Report"
                                            sheet="Exceptional RPS/PRP Report"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <FilterOptionsEC filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
                ...
                <Row>
                    <Col xs={12} className="datatable">
                        <div className="table-responsive analysistableheight" style={{maxHeight: '100%'}}>
                            ...
                            <thead>
                                <tr>
                                    <th  colSpan="20"><div className="reporttable-head"> {mainHead} </div></th>
                                </tr>
                                </thead>
                                {/* {this.props.open==true&&} */}
                                <TableHeader
