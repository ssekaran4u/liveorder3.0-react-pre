...
import FilterOptionsPRPACTIVITY from './FilterOptionsPRPACTIVITY'

import ColumnOption from "./ColumnOption";

class ReportTablePRPACTIVITY extends Datatable {
   constructor(props){
    super(props)
    this.state = {
        ...this.state,
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        {/* <ReactHTMLTableToExcel
                                            ...
                                            filename="PRPActivityReport"
                                            sheet="PRPActivityReport"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <FilterOptionsPRPACTIVITY filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
