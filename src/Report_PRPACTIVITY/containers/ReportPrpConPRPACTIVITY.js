...
import ReportHeaderPRPACTIVITY from "../components/ReportHeaderPRPACTIVITY";

import { connect } from "react-redux";
import ReportListPRPACTIVITY from "../components/ReportListPRPACTIVITY";

class ReportPrpConPRPACTIVITY extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div className="content-spacing body-scroll">
                <div className="min-height-100">
                    <div className="dcr-head">
                        <div>
                            <h4 className="daily-call-report">
                                {this.props.token}PRP Activity Report
                            </h4>
                        </div>
                        <div>
                    ...
                    <div className="dcr-list-sec">
                        ...
                        >
                           <ReportHeaderPRPACTIVITY open={this.state.open} onHeaderHide={this.onHeaderHide}   />
                            <ReportListPRPACTIVITY  Devision={this.state.Devision} open={this.state.open} />
                        </div>
                    </div>
