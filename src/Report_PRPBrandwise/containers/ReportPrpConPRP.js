...
import ReportHeaderPRP from "../components/ReportHeaderPRP";

import { connect } from "react-redux";
import ReportListPRP from "../components/ReportListPRP";

class ReportPrpConPRP extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div className="content-spacing body-scroll">
                <div className="min-height-100">
                    <div className="dcr-head">
                        <div>
                            <h4 className="daily-call-report">
                                {this.props.token}PRP Brand wise Activity Report 
                            </h4>
                        </div>
                        <div>
                            <Breadcrumb className="dcr-breadcrumb">
                                ...
                                PRP Brand wise Activity Report 
                                </Breadcrumb.Item>
                            </Breadcrumb>
                        </div>
                    </div>
                    ...
                    <div className="dcr-list-sec">
                        ...
                        >
                            <ReportHeaderPRP  open={this.state.open} onHeaderHide={this.onHeaderHide}/>
                            <ReportListPRP  Devision={this.state.Devision} open={this.state.open}  />
                        </div>
                    </div>
