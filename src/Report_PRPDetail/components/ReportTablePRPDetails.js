...
import FilterOptionsPRPDetails from './FilterOptionsPRPDetails'
import ColumnOption from '../../Report_RPSINVEST/components/ColumnOption'



class ReportTablePRPDetails extends Datatable {
   constructor(props){
    super(props)
    this.state = {
        ...this.state,
...
//    };
   ...
   changeDisplayedColumns(e) {
    ...
    getFuncprops(status){
     ...
     getfunApply(name){
      this.props.applyFilter(name,"test  success")
      }
      handleExcel(){
    ...
    componentDidMount(){
        this.setState({displayedColumns : ['Division Name',
        'Region Name',
        'PRP No',
        'PRP Name',
        'Requested Date',
        ...
        this.setState({columnlist : ['Division Name',
        'Region Name',
        'PRP No',
        'PRP Name',
        'Requested Date',
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        <ReactHTMLTableToExcel
                                            ...
                                            filename="PRPDetailsReport"
                                            sheet="PRPDetailsReport"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <FilterOptionsPRPDetails filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
