...
import FilterOptionsRpsConsole from './FilterOptionsRpsConsole'
import ColumnOption from '../../Report_RPSINVEST/components/ColumnOption'



class ReportTableRpsConsole extends Datatable {
   constructor(props){
    super(props)
    this.state = {
        ...this.state,
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        <ReactHTMLTableToExcel
                                            ...
                                            filename="ConsolidatedReportForRPS"
                                            sheet="ConsolidatedReportForRPS"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <FilterOptionsRpsConsole filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
                ...
                <Row>
                    <Col xs={12} className="datatable">
                        <div className="table-responsive analysistableheight" style={{maxHeight: '100%'}}>
                            ...
                            <thead>
                                <tr>
                                    <th colSpan="28"><div className="reporttable-head"> {mainHead} </div></th>
                                </tr>
                                </thead>
