...
import ReportHeaderRpsConsole from "../components/ReportHeaderRpsConsole";

import { connect } from "react-redux";
import ReportListRpsConsole from "../components/ReportListRpsConsole";

class ReportRpsConsole extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div className="content-spacing body-scroll">
                <div className="min-height-100">
                    <div className="dcr-head">
                        <div>
                            <h4 className="daily-call-report">
                                {this.props.token}Consolidated Report For RPS
                            </h4>
                        </div>
                        <div>
                    ...
                    <div className="dcr-list-sec">
                        ...
                        >
                            <ReportHeaderRpsConsole  open={this.state.open} onHeaderHide={this.onHeaderHide}/>
                            <ReportListRpsConsole  Devision={this.state.Devision} open={this.state.open}  />
                        </div>
                    </div>
