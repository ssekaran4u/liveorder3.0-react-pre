...
import FilterOptionsRPSINVEST from './FilterOptionsRPSINVEST'
...
class ReportTableRPSINVEST extends Datatable {
   constructor(props){
    super(props)
    this.state = {
        ...this.state,
   ...
   // created new
    ...
    this.changeDisplayedColumns = this.changeDisplayedColumns.bind(this)
     ...
     getFilterData(division,region,area,fsname,month,year){
        this.props.getFilterData(division,region,area,fsname,month,year)
    }
    ...
    componentDidMount(){
        this.setState({displayedColumns : ['REGION',
        'FS NAME',
        'AREA',
        'DATE',
        'SRNO',
        ...
        this.setState({columnlist : ['REGION',
        'FS NAME',
        'AREA',
        'DATE',
        'SRNO',
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        <ReactHTMLTableToExcel
                                            ...
                                            filename="PRPandRPSFSwiseInvestmentHistoryReport"
                                            sheet="PRPandRPSFSwiseInvestmentHistoryReport"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <FilterOptionsRPSINVEST filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
                ...
                <Row>
                    <Col xs={12} className="datatable">
                        <div className="table-responsive analysistableheight" style={{maxHeight: '100%'}}>
                            ...
                            <thead>
                                <tr>
                                    <th  colSpan="19"><div className="reporttable-head"> {mainHead} </div></th>
                                </tr>
                                </thead>
                            {/* {this.props.open==true&&} */}
                                <TableHeader
