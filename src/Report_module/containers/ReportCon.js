...
class ReportCon extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <div className="min-height-100">
                    <div className="dcr-head">
                        <div>
                            <h4 className="daily-call-report">
                                {this.props.token}RPS Brand wise Report
                            </h4>
                        </div>
                        <div>
                    ...
                    <div className="dcr-list-sec">
                        <div
                         ...
                         >
                             <ReportHeader open={this.state.open} onHeaderHide={this.onHeaderHide}   />
                            <ReportList  Devision={this.state.Devision} open={this.state.open} />
                        </div>
                    </div>
