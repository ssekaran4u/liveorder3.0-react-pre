...
import FilterOptionsRPSAct from './FilterOptionsRPSAct'
import ColumnOption from '../../Report_RPSINVEST/components/ColumnOption'



class ReportTableAct extends Datatable {
   constructor(props){
    super(props)
    this.state = {
        ...this.state,
            ...
            <React.Fragment>
               ...
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        <ReactHTMLTableToExcel
                                            ...
                                            filename="RPSActivityReport"
                                            sheet="RPSActivityReport"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <FilterOptionsRPSAct filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
