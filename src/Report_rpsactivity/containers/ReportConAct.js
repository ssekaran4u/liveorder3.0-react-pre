...
import ReportHeaderAct from "../components/ReportHeaderAct";
//import DCRListTable from "../components/DCRListTable";

import { connect } from "react-redux";
import ReportListAct from "../components/ReportListAct";

class ReportConAct extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div className="content-spacing body-scroll">
                <div className="min-height-100">
                    <div className="dcr-head">
                        <div>
                            <h4 className="daily-call-report">
                                {this.props.token}RPS Activity Report
                            </h4>
                        </div>
                        <div>
                    ...
                    <div className="dcr-list-sec">
                        ...
                        >
                            <ReportHeaderAct open={this.state.open} onHeaderHide={this.onHeaderHide}   />
                            <ReportListAct  Devision={this.state.Devision} open={this.state.open} />
                        </div>
                    </div>
