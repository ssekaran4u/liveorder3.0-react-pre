...
class Managerapprvrejectable extends Datatable{

      
    showRejectmodal(action){
        this.props.showRejectmodal(action,'')
    }
                    ...
                    <div className="dcr-table-optionsfc">
                        ...
                        <div className="sfcfullimg">
                            <div className="fullScreen-mysfcimage">
                                <button onClick={()=>this.showApprovemodal("A")} className="partiallyActiveTextYellowapproved1" >Approve</button>
                                <button  onClick={()=>this.showRejectmodal("R")}  className= "activeTextGreenpending1">Reject</button>
                                </div>
                         </div>: null } */}
                        <div className="sfcfullimg">
                        {this.props.sfcStatus == "Pending"  || this.props.sfcStatus == "Partially Approved"  ? 
                            <div className="fullScreen-mysfcimage">
                                <button onClick={()=>this.showApprovemodal("A")} className="partiallyActiveTextYellowapproved1" >Approve</button>
                                {/* <button  onClick={()=>this.showRejectmodal("R")}  className= "activeTextGreenpending1">Reject</button> */}
                                </div>:null}
...
export default Managerapprvrejectable