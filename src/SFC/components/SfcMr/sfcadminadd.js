...
class Sfcadminadd extends Component {
  constructor(props) {
    super(props)
  ...
  Get_area() {
    ...
    postToServer("SFC", data).then((Result) => {
     ...
     // console.log(Result, 'kunal sinha')
    })
    ...
    return (
      <React.Fragment>
       ...
       <div className="alldropsfclocation">
        ...
        />
        <Sfcadminapprvrejectpage  hidearea={this.state.hidearea} setup_id={this.state.setup_id} travedrop={this.state.travedrop} SFCLOCKED={this.state.SFCLOCKED}  data={this.props.data} reload={this.state.reload} sfcno={this.props.match.params.id} n_srno={this.props.match.params.id}/>
...
export default withRouter(Sfcadminadd)