...
class Sfcdetailtable extends Datatable{
            ...
            <div className="dcr-table">
                ...
                <div className="pagination-sec">
                    ...
                    <div className="apprvby-date">
                        <p className="apprvby">Approved By : <span className="managerby"> Manager 23 </span> , Date : <span className="managerby"> 20-Nov-19.</span></p>
                    </div>
                    <Pagination
                        data={sortedData}
                        rowsPerPage={rowsPerPage}
