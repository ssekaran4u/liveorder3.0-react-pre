...
class Sfcmanageradd extends Component {
  constructor(props) {
    super(props)
    ...
    return (
      <React.Fragment>
       ...
       <div className="alldropsfclocation">
        ...
        />
        <Managerapprvrejectpage  hidearea={this.state.hidearea} setup_id={this.state.setup_id} travedrop={this.state.travedrop} SFCLOCKED={this.state.SFCLOCKED}  data={this.props.data} reload={this.state.reload} sfcno={this.props.match.params.id} />
...
export default withRouter(Sfcmanageradd)