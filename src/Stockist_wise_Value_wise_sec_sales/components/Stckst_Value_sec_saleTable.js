...
import Stckst_Value_sec_saleOptions from './Stckst_Value_sec_saleOptions'



class Stckst_Value_sec_saleTable extends Datatable {
   constructor(props){
    super(props)
            ...
            <React.Fragment>
               <div className="flex-row pt20">
                    ...
                    <Dropdown>
                               ...
                               <div className="dcrlistexport export-ops">
                                   ...
                                   <div>
                                        ...
                                        <ReactHTMLTableToExcel
                                            ...
                                            tableHeader="sojan"
                                            filename="Stockist wise Value wise secondary sales report"
                                            sheet="tablexls"
                                            buttonText="Excel"/>
                                   </div>
                        ...
                        <Stckst_Value_sec_saleOptions filterapply={this.getfunApply}  update={this.updateState}  selecteddiv={this.props.selecteddiv} funcprops={this.getFuncprops} getFilterData={this.getFilterData.bind(this)} />
                        <div className="other-ops mr10">
                            <Filter
