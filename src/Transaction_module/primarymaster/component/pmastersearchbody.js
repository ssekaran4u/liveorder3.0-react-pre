...
class Pmastersearchbody extends Datatable {
    render() {
                ...
                <div className="dcr-table">
                    ...
                    <div className="dcr-table-optionsfc">
                        ...
                        <div className="sfcfullimg">
                            {/* <div className="submitchart"><button onClick = {this.props.onCloseSearchTable} className="submitchartbtn" >Close</button></div> */}
...
export default Pmastersearchbody;
