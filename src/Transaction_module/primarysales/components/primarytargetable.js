...
import Primarytargetbody from './primarytargetbody';
import { URL_SALES } from '../../../lib/constants'
import SfaModal from "./../../../BasicComponet/sfaModal";



class  Primarytargetable extends Component {
    ...
    onClicksave() {
        ...
        postToServer(URL_SALES, clicksavedata).then((response) => {
            ...
            if (response.status == 200 ) {
                ...
                this.setState({ clicksave: response.data.data })
...
export default Primarytargetable;        