...
export const getProductDetail= (data) => {
    return (dispatch) => {
        postToServer(URL_DCR,data).then(function(resp) {        
...
export const getProductDropdown = (data) => { 
    return (dispatch) => {
        postToServer(URL_PRODUCT_DROPDOWN,data).then(function(resp) { 
...
export const getDcotorRCPA = (data) => { 
    return (dispatch) => {
        postToServer("RCPA_API", data).then(function(resp) {
            dispatch(getDcrRCPA(resp.data["Result"]))
        })
    }
}
...
export const getRCPA = (data) => { 
    return (dispatch) => {
        postToServer("DCRAPI",data).then(function(resp) {
