...
class DashboardMrCustomTable extends Datatable {
    constructor(props){
        super(props)
    ...
    handleChecked(e){
        ...
        // console.log(doctorGradeFilter,'filtername')
    }
    ...
    render() {
        ...
        let filtergrad={}
         ...
         //console.log( this.props.tableBody, "average table");
        return (
            <div>
                        ...
                        <Dropdown>
                            ...
                            <Dropdown.Menu className="column-dropdown">
                                <div className="pad10 columns-height cal-scrollbar">
                                    <h5 className="drop-head">Grade</h5>
                                    <Form>
...
export default DashboardMrCustomTable;