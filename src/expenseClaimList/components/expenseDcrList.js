...
class ExpenseDcrList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            list: []
    ...
    componentDidMount() {
        ...
        let data = {
            "Index": "DcrReport",
            "Data": { "srno": this.props.match.params.reportNo, "date": dte }
        }
                ...
                if (Result.data.data.length) {
                    Result.data.data.map(res => {
                        ...
                        array.push({
                            action: true,
                            dcrNo: res.DcrNo,
                            place: res.PlaceOfWork == "" ? "--" : res.PlaceOfWork,
                            workWith: res.WorkedWith == "" ? "--" : res.WorkedWith,
                            stay: res.PlaceOfStay == "" ? "--" : res.PlaceOfStay,
                            workType: res.WorkType == "" ? "--" : res.WorkType,
                ...
                <div className="admindashboard">
                    <div className="content-spacing dashscroll">
                        <div className="expense_dcr_list">
                            <Breadcrumbs content="Expense Claim Entry Template - DCR Details" subContent={subContent} />
                            <Card className="expense_dcr_list_card">
                                <div className="expense_dcr_table_heading">
                                    DCR Details for {this.props.match.params.date}.
                                </div>
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th className="remarks_head">
                                                    <div className="header-txt">Remarks</div>
                                                </th>
                                                <th className="reason_head">
                                                    <div className="header-txt">Reason</div>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {this.state.list.map(res =>
                                                <React.Fragment>
                                                    <tr key={res.dcrNo}>
                                                        ...
                                                        <td>
                                                            <div className="body_txt">{res.remarks}</div>
                                                        </td>
                                                        <td>
                                                            <div className="body_txt">{res.reason}</div>
                                                        </td>
                                                    </tr>
                                                    {res.action == true ?
                                                        <React.Fragment>
...
export default withRouter(ExpenseDcrList);
