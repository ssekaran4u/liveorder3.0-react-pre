...
class ManagerCallAverageRegionalManagerCard extends Component {
    constructor() {
        super();
        this.state = {
            isFull: false,
                    ...
                    <Accordion.Toggle as={Card.Header} variant="link" eventKey="1" className="manager_seconday_accor_toggle" onClick={this.handleplus}>
                        <div className="manager_seconday_accor_cardholder">
                            <div className="manager-seconday_left-containet">
                                ...
                                <div className="manager_callavaerage_sales">
                                    <p className="head">Team Calls Avg.</p>
                                    <p className="blackvalue">250</p>
                                </div>
                                <div className="manager_callavaerage_sales">
                                    <p className="head">Team Call Average</p>
                                    <p className="blackvalue">9</p>
                                </div>
                            </div>
                        </div>
                    </Accordion.Toggle>
...
export default ManagerCallAverageRegionalManagerCard