...
class MrCustomTable extends Datatable {
                        ...
                        <Dropdown.Item href="#/action-1" >
                           <div className="statusdropmenu" >
                              ...
                              {this.props.requestdata ? this.props.requestdata.map((item,index) => (
                                <div key={index} className="statussubmenu" onClick={((e) => this.handleStatus(item.Code)).bind(this)} >{item.Name}</div>
                                )): ''}
                           </div>
                        </Dropdown.Item>
                        ...
                        <Dropdown.Item href="#/action-1" >
                            <div className="statusdropmenu" >
                                {this.props.requestTypeList ? this.props.requestTypeList.map((item,index)=>(
                                  <div key={index} className="statussubmenu" onClick={((e) => this.handleType(item.Code)).bind(this)} >{item.Name}</div>    
                                )):''}
